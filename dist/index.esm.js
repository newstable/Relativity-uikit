...
var templateObject_1$K, templateObject_2$f, templateObject_3$7;
...
var Icon$F = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React.createElement("image", { width: 90, height: 90, href: "/images/icicb/logo-1.png" })));
};
...
var templateObject_1$F, templateObject_2$e, templateObject_3$6, templateObject_4$2;
...
var NewStyledButton = styled.button(templateObject_1$C || (templateObject_1$C = __makeTemplateObject(["\n  align-items: center;\n  border:none;\n  border-bottom:1px solid white;\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: 700;\n  /* max-content instead of auto for Safari fix */\n  width: ", ";\n  height: ", ";\n  line-height: 1;\n  letter-spacing: 0.03em;\n  justify-content: center;\n  outline: 0;\n  padding: ", ";\n  transition: background-color 0.2s;\n  opacity: ", ";\n  color:white;\n\n  &:hover:not(:disabled):not(.button--disabled):not(:active) {\n    border-bottom:2px solid #4c4a50;\n    background-color: transparent;\n  }\n\n  ", "\n  ", "\n  ", "\n"], ["\n  align-items: center;\n  border:none;\n  border-bottom:1px solid white;\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: 700;\n  /* max-content instead of auto for Safari fix */\n  width: ", ";\n  height: ", ";\n  line-height: 1;\n  letter-spacing: 0.03em;\n  justify-content: center;\n  outline: 0;\n  padding: ", ";\n  transition: background-color 0.2s;\n  opacity: ", ";\n  color:white;\n\n  &:hover:not(:disabled):not(.button--disabled):not(:active) {\n    border-bottom:2px solid #4c4a50;\n    background-color: transparent;\n  }\n\n  ", "\n  ", "\n  ", "\n"])), function (_a) {
    var fullWidth = _a.fullWidth;
    return (fullWidth ? "100%" : "max-content");
}, function (_a) {
    var size = _a.size;
...
var SwapButton = function (_a) {
    ...
    var internalProps = external ? getExternalLinkProps() : {};
    var isDisabled = isLoading || disabled;
    return (React.createElement(NewStyledButton, __assign({}, internalProps, props, { isLoading: isLoading, disabled: isDisabled }),
        React.isValidElement(startIcon) &&
            React.cloneElement(startIcon, {
                mr: "0.5rem",
            }),
...
var InactiveButton = styled(SwapButton)(templateObject_1$B || (templateObject_1$B = __makeTemplateObject(["\n  background-color: transparent;\n  border:none;\n  height:50px;\n  color: ", ";\n\n  &:hover:not(:disabled):not(:active) {\n    background-color: transparent;\n  }\n"], ["\n  background-color: transparent;\n  border:none;\n  height:50px;\n  color: ", ";\n\n  &:hover:not(:disabled):not(:active) {\n    background-color: transparent;\n  }\n"])), function (_a) {
...
var ButtonMenuItem = function (_a) {
    ...
    return React.createElement(SwapButton, __assign({ as: as, size: size, variant: variant }, props));
};
...
var LinkExternal = function (_a) {
    ...
    return (React.createElement(Link, __assign({ external: true }, props),
        children,
        React.createElement(Icon$H, { color: "white", ml: "4px" })));
};
...
var templateObject_1$h, templateObject_2$8, templateObject_3$4, templateObject_4$1, templateObject_5$1;
    ...
    return (React.createElement(StyledModal, null,
        React.createElement(ModalHeader, null,
            ...
            !hideCloseButton && (React.createElement(IconButton, { variant: "tertiary", onClick: onDismiss, "aria-label": "Close the dialog" },
                React.createElement(Icon$Q, { color: "thirdBright" })))),
        React.createElement(Flex, { flexDirection: "column", p: bodyPadding }, children)));
};
var templateObject_1$f, templateObject_2$6, templateObject_3$2;
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "-50 0 255 150" }, props),
        React.createElement("image", { width: "140", height: "140", href: isDark ? '/images/icicb/logo-2.png' : '/images/icicb/logo-2.png' })));
};
...
var templateObject_1$b, templateObject_2$5, templateObject_3$1;
...
var Accordion = function (_a) {
    var label = _a.label, icon = _a.icon, isPushed = _a.isPushed; _a.pushNav; var _b = _a.initialOpenState, initialOpenState = _b === void 0 ? false : _b, children = _a.children, className = _a.className;
    var _c = useState(initialOpenState), isOpen = _c[0]; _c[1];
    return (React.createElement(Container$2, null,
        React.createElement(MenuEntry, { className: className },
            icon,
...
var PanelFooter = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav; _a.toggleTheme; _a.isDark; _a.cakePriceUsd; _a.currentLang; _a.langs; _a.setLang; _a.priceLink;
    if (!isPushed) {
...
var WalletCard = function (_a) {
    ...
    return (React.createElement(Button, { fullWidth: true, variant: "tertiary", onClick: function () {
        ...
        React.createElement("div", { style: { fontSize: "16px", fontWeight: "600", lineHeight: "1.5" } }, title),
...
var SocialEntry = styled.div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  height: ", "px;\n  padding: 0 16px;\n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  height: ", "px;\n  padding: 0 16px;\n"])), MENU_ENTRY_HEIGHT);
var PriceLink = styled.a(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"])));
...
var Menu = function (_a) {
    ...
    return (React.createElement(Wrapper, null,
        React.createElement(StyledNav, { showMenu: showMenu },
            ...
            React.createElement(Flex, null,
                React.createElement(SocialEntry, null, cakePriceUsd ? (React.createElement(PriceLink, { href: priceLink, target: "_blank" },
                    React.createElement(Icon$F, { width: "45px", mr: "8px" }),
        ...
        React.createElement("div", { style: { position: "absolute", bottom: "110px", right: "50px", zIndex: "40" } },
            React.createElement(Button, { variant: "text", startIcon: React.createElement(LanguageIcon, { color: "textSubtle", width: "24px" }), style: { backgroundColor: "transparents" } }, "EN"))));
};
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundRepeat: "no-repeat", backgroundSize: "100% 100%", backgroundDisabled: "#E9EAEB", contrast: "#f4f7fa", invertedContrast: "black", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#452A7A", textDisabled: "#BDC2C4", textSubtle: "#113049", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#bddaf8", background: "url(/images/background.png)", backgroundRepeat: "no-repeat", backgroundSize: "100% 100%", backgroundDisabled: "#113049", contrast: "#FFFFFF", invertedContrast: "#f4f7fa", input: "#090805", primaryDark: "#0098A1", tertiary: "#090805", text: "#e4e8ea", textDisabled: "#666171", textSubtle: "#b8b8b8", borderColor: "#D0B49F", card: "#090805", gradients: {
...
export { Icon$15 as AddIcon, Alert, Icon$14 as ArrowBackIcon, Icon$13 as ArrowDownIcon, Icon$12 as ArrowDropDownIcon, Icon$11 as ArrowDropUpIcon, Icon$$ as ArrowForwardIcon, Icon$_ as AutoRenewIcon, BackgroundImage, GridLayout$1 as BaseLayout, Icon$Z as BinanceIcon, Icon$17 as BlockIcon, Breadcrumbs, Icon$Y as BunnyPlaceholderIcon, Button, ButtonMenu, ButtonMenuItem, Icon$W as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$X as CardViewIcon, GridLayout as CardsLayout, Checkbox, Icon$19 as CheckmarkCircleIcon, Icon$V as CheckmarkIcon, Icon$U as ChevronDownIcon, Icon$T as ChevronLeftIcon, Icon$S as ChevronRightIcon, Icon$R as ChevronUpIcon, Icon$Q as CloseIcon, Icon$P as CogIcon, Icon$O as CommunityIcon, Icon$N as CopyIcon, CopyToClipboard, Dropdown, Icon$18 as ErrorIcon, Flex, Icon$E as GooseRoundIcon, Heading, Icon$M as HelpIcon, IconButton, Image, Icon$16 as InfoIcon, Input$1 as Input, Link, LinkExternal, Icon$L as ListViewIcon, Icon$K as LogoIcon, Icon$J as LogoRoundIcon, Menu, Icon$I as MinusIcon, Modal, ModalProvider, Icon$H as OpenNewIcon, Icon$F as PancakeRoundIcon, Icon$G as PancakesIcon, Icon$D as PrizeIcon, Progress, Icon$A as ProgressBunny, Radio, Icon$C as RemoveIcon, ResetCSS, Icon$w as SearchIcon, Skeleton, Spinner, Svg, Icon$v as SwapVertIcon, Icon$u as SyncAltIcon, Tag, Text, Icon$y as Ticket, Icon$x as TicketRound, ToastContainer, Toggle, Icon$10 as TradeIcon, Icon$B as VerifiedIcon, Icon$t as WarningIcon, Icon$z as Won, variants as alertVariants, byTextAscending, byTextDescending, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, types as toastTypes, useMatchBreakpoints, useModal, useParticleBurst, useTable, useWalletModal };
