...
}, getDisabledStyles$1, removePointerEvents$1, styledSystem.space);
...
var Icon$F = function (props) {
    return (React__default["default"].createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default["default"].createElement("image", { width: 90, height: 90, href: "/images/icicb/logo-1.png" })));
};
...
var NewStyledButton = styled__default["default"].button(templateObject_1$C || (templateObject_1$C = __makeTemplateObject(["\n  align-items: center;\n  border:none;\n  border-bottom:1px solid white;\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: 700;\n  /* max-content instead of auto for Safari fix */\n  width: ", ";\n  height: ", ";\n  line-height: 1;\n  letter-spacing: 0.03em;\n  justify-content: center;\n  outline: 0;\n  padding: ", ";\n  transition: background-color 0.2s;\n  opacity: ", ";\n  color:white;\n\n  &:hover:not(:disabled):not(.button--disabled):not(:active) {\n    border-bottom:2px solid #4c4a50;\n    background-color: transparent;\n  }\n\n  ", "\n  ", "\n  ", "\n"], ["\n  align-items: center;\n  border:none;\n  border-bottom:1px solid white;\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: 700;\n  /* max-content instead of auto for Safari fix */\n  width: ", ";\n  height: ", ";\n  line-height: 1;\n  letter-spacing: 0.03em;\n  justify-content: center;\n  outline: 0;\n  padding: ", ";\n  transition: background-color 0.2s;\n  opacity: ", ";\n  color:white;\n\n  &:hover:not(:disabled):not(.button--disabled):not(:active) {\n    border-bottom:2px solid #4c4a50;\n    background-color: transparent;\n  }\n\n  ", "\n  ", "\n  ", "\n"])), function (_a) {
    var fullWidth = _a.fullWidth;
    return (fullWidth ? "100%" : "max-content");
}, function (_a) {
    var size = _a.size;
...
var SwapButton = function (_a) {
    ...
    var internalProps = external ? getExternalLinkProps() : {};
    var isDisabled = isLoading || disabled;
    return (React__default["default"].createElement(NewStyledButton, __assign({}, internalProps, props, { isLoading: isLoading, disabled: isDisabled }),
        React__default["default"].isValidElement(startIcon) &&
            React__default["default"].cloneElement(startIcon, {
                mr: "0.5rem",
            }),
...
var InactiveButton = styled__default["default"](SwapButton)(templateObject_1$B || (templateObject_1$B = __makeTemplateObject(["\n  background-color: transparent;\n  border:none;\n  height:50px;\n  color: ", ";\n\n  &:hover:not(:disabled):not(:active) {\n    background-color: transparent;\n  }\n"], ["\n  background-color: transparent;\n  border:none;\n  height:50px;\n  color: ", ";\n\n  &:hover:not(:disabled):not(:active) {\n    background-color: transparent;\n  }\n"])), function (_a) {
...
var ButtonMenuItem = function (_a) {
    ...
    return React__default["default"].createElement(SwapButton, __assign({ as: as, size: size, variant: variant }, props));
};
...
var LinkExternal = function (_a) {
    ...
    return (React__default["default"].createElement(Link, __assign({ external: true }, props),
        children,
        React__default["default"].createElement(Icon$H, { color: "white", ml: "4px" })));
};
    ...
    return (React__default["default"].createElement(StyledModal, null,
        React__default["default"].createElement(ModalHeader, null,
            ...
            !hideCloseButton && (React__default["default"].createElement(IconButton, { variant: "tertiary", onClick: onDismiss, "aria-label": "Close the dialog" },
                React__default["default"].createElement(Icon$Q, { color: "thirdBright" })))),
...
var Logo$1 = function (_a) {
    ...
    return (React__default["default"].createElement(Svg, __assign({ viewBox: "-50 0 255 150" }, props),
        React__default["default"].createElement("image", { width: "140", height: "140", href: isDark ? '/images/icicb/logo-2.png' : '/images/icicb/logo-2.png' })));
};
...
var Accordion = function (_a) {
    ...
    var _c = React.useState(initialOpenState), isOpen = _c[0]; _c[1];
    return (React__default["default"].createElement(Container$2, null,
        React__default["default"].createElement(MenuEntry, { className: className },
            icon,
...
var WalletCard = function (_a) {
    ...
    return (React__default["default"].createElement(Button, { fullWidth: true, variant: "tertiary", onClick: function () {
        ...
        React__default["default"].createElement("div", { style: { fontSize: "16px", fontWeight: "600", lineHeight: "1.5" } }, title),
...
var CopyToClipboard = function (_a) {
    ...
    return (React__default["default"].createElement(StyleButton, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React__default["default"].createElement(Icon$N, { width: "20px", color: "white", ml: "4px" }),
...
var SocialEntry = styled__default["default"].div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  height: ", "px;\n  padding: 0 16px;\n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  height: ", "px;\n  padding: 0 16px;\n"])), MENU_ENTRY_HEIGHT);
var PriceLink = styled__default["default"].a(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"])));
...
var Menu = function (_a) {
    ...
    return (React__default["default"].createElement(Wrapper, null,
        ...
        React__default["default"].createElement("div", { style: { position: "absolute", bottom: "110px", right: "50px", zIndex: "40" } },
            React__default["default"].createElement(Button, { variant: "text", startIcon: React__default["default"].createElement(LanguageIcon, { color: "textSubtle", width: "24px" }), style: { backgroundColor: "transparents" } }, "EN"))));
};
